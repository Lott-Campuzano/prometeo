...
<div class="min-h-screen flex items-center justify-center bg-gray-100">
  <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md space-y-6">
    ...
    <form method="post" action="../autenticacion/process.php" class="space-y-4">
      <div>
      ...
      <button type="submit"
        class="w-full bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition">Iniciar sesión</button>
    </form>
    <div class="text-center">
      ...
      <form action="register.php">
        ...
        <button type="submit"
          class="mt-2 w-full bg-gray-200 text-gray-800 py-2 px-4 rounded-lg hover:bg-gray-300 transition">Crear cuenta</button>
      </form>
    </div>
  </div>
</div>